...
class Submission(SubmissionSpec12):
    ...
    def calculate_pseudo_emission_matrix_for_tag(self, word, tag_index):
    ...
    def predict(self, sentence):
        ...
        for idx, tag in enumerate(self.tags):
            ...
            try:
                ...
                b = self.calculate_pseudo_emission_matrix_for_tag(first_word_in_sentence, idx)
        ...
        for i in range(1,y_length):
            for j in range(self.N):
                try:
                    ...
                    # if word is unknown - we will calculate the psuedo_emission_matrix as before
                    b = self.calculate_pseudo_emission_matrix_for_tag(sentence[i], j)
